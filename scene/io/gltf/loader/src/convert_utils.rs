...
use rendiation_scene_core::{AlphaMode, InterpolationStyle, SceneAnimationField};

pub fn map_sampler(sampler: gltf::texture::Sampler) -> rendiation_texture_core::TextureSampler {
  rendiation_texture_core::TextureSampler {
    address_mode_u: map_wrapping(sampler.wrap_s()),
    address_mode_v: map_wrapping(sampler.wrap_t()),
    address_mode_w: rendiation_texture_core::AddressMode::ClampToEdge,
    mag_filter: sampler
      .mag_filter()
      .map(map_mag_filter)
      .unwrap_or(rendiation_texture_core::FilterMode::Nearest),
    min_filter: sampler
      .min_filter()
      .map(map_min_filter)
      .unwrap_or(rendiation_texture_core::FilterMode::Nearest),
...
pub fn map_wrapping(mode: gltf::texture::WrappingMode) -> rendiation_texture_core::AddressMode {
  match mode {
    gltf::texture::WrappingMode::ClampToEdge => rendiation_texture_core::AddressMode::ClampToEdge,
    gltf::texture::WrappingMode::MirroredRepeat => {
      rendiation_texture_core::AddressMode::MirrorRepeat
    }
    gltf::texture::WrappingMode::Repeat => rendiation_texture_core::AddressMode::Repeat,
  }
}

pub fn map_min_filter(min: gltf::texture::MinFilter) -> rendiation_texture_core::FilterMode {
  match min {
    gltf::texture::MinFilter::Nearest => rendiation_texture_core::FilterMode::Nearest,
    gltf::texture::MinFilter::Linear => rendiation_texture_core::FilterMode::Linear,
    gltf::texture::MinFilter::NearestMipmapNearest => rendiation_texture_core::FilterMode::Nearest,
    gltf::texture::MinFilter::LinearMipmapNearest => rendiation_texture_core::FilterMode::Linear,
    gltf::texture::MinFilter::NearestMipmapLinear => rendiation_texture_core::FilterMode::Nearest,
    gltf::texture::MinFilter::LinearMipmapLinear => rendiation_texture_core::FilterMode::Linear,
  }
}

/// https://www.khronos.org/opengl/wiki/Sampler_Object
pub fn map_min_filter_mipmap(min: gltf::texture::MinFilter) -> rendiation_texture_core::FilterMode {
  match min {
    gltf::texture::MinFilter::Nearest => rendiation_texture_core::FilterMode::Nearest,
    gltf::texture::MinFilter::Linear => rendiation_texture_core::FilterMode::Nearest,
    gltf::texture::MinFilter::NearestMipmapNearest => rendiation_texture_core::FilterMode::Nearest,
    gltf::texture::MinFilter::LinearMipmapNearest => rendiation_texture_core::FilterMode::Nearest,
    gltf::texture::MinFilter::NearestMipmapLinear => rendiation_texture_core::FilterMode::Linear,
    gltf::texture::MinFilter::LinearMipmapLinear => rendiation_texture_core::FilterMode::Linear,
  }
}

pub fn map_mag_filter(f: gltf::texture::MagFilter) -> rendiation_texture_core::FilterMode {
  match f {
    gltf::texture::MagFilter::Nearest => rendiation_texture_core::FilterMode::Nearest,
    gltf::texture::MagFilter::Linear => rendiation_texture_core::FilterMode::Linear,
  }
}
