...
This implementation is roughly based on the <https://github.com/zeux/meshoptimizer> v 0.24.  It is pretty simple, just a greedy search solution for graph partition problem.
