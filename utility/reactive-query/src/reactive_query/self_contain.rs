...
pub trait ReactiveValueRefQuery:
  ReactiveQuery<
  Compute: ReactiveQueryCompute<View: DynValueRefQuery<Key = Self::Key, Value = Self::Value>>,
>
{
...
where
  T: ReactiveQuery,
  <T::Compute as ReactiveQueryCompute>::View: DynValueRefQuery<Key = T::Key, Value = T::Value>,
{
}
