...
pub fn load_default_scene_lighting_test(
...
pub fn load_ltc_lighting_test(writer: &mut SceneWriter, scene: EntityHandle<SceneEntity>) {
  // ground
  {
  ...
  area_light_writer.new_entity(|w| {
    w.write::<AreaLightSize>(&Vec2::new(1., 1.))
      ...
      .write::<AreaLightRefScene>(&scene.some_handle())
  });
}
