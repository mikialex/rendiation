...
pub fn get_suitable_shader_write_ty_from_texture_format(
  ...
  use PrimitiveShaderValueType::Scalar;
  use ScalarType::*;
  use VectorSize::*;
  let vector = PrimitiveShaderValueType::vector;
  let ty = match format {
    TextureFormat::R8Unorm => Scalar(F32),
    TextureFormat::R8Snorm => Scalar(F32),
    TextureFormat::R8Uint => Scalar(U32),
    TextureFormat::R8Sint => Scalar(I32),
    TextureFormat::R16Uint => Scalar(U32),
    TextureFormat::R16Sint => Scalar(I32),
    TextureFormat::R16Unorm => Scalar(F32),
    TextureFormat::R16Snorm => Scalar(F32),
    TextureFormat::R16Float => vector(Quad, F32), // https://github.com/gfx-rs/wgpu/issues/7702
    TextureFormat::Rg8Unorm => vector(Bi, F32),
    TextureFormat::Rg8Snorm => vector(Bi, F32),
    TextureFormat::Rg8Uint => vector(Bi, U32),
    TextureFormat::Rg8Sint => vector(Bi, I32),
    TextureFormat::R32Uint => Scalar(U32),
    TextureFormat::R32Sint => Scalar(I32),
    TextureFormat::R32Float => Scalar(F32),
    TextureFormat::Rg16Uint => vector(Bi, U32),
    TextureFormat::Rg16Sint => vector(Bi, I32),
    TextureFormat::Rg16Unorm => vector(Bi, F32),
    TextureFormat::Rg16Snorm => vector(Bi, F32),
    TextureFormat::Rg16Float => vector(Quad, F32), // https://github.com/gfx-rs/wgpu/issues/7702
    TextureFormat::Rgba8Unorm => vector(Quad, F32),
    TextureFormat::Rgba8UnormSrgb => vector(Quad, F32),
    TextureFormat::Rgba8Snorm => vector(Quad, F32),
    TextureFormat::Rgba8Uint => vector(Quad, U32),
    TextureFormat::Rgba8Sint => vector(Quad, I32),
    TextureFormat::Bgra8Unorm => vector(Quad, F32),
    TextureFormat::Bgra8UnormSrgb => vector(Quad, F32),
    TextureFormat::Rgb9e5Ufloat => vector(Quad, F32),
    TextureFormat::Rgb10a2Uint => vector(Quad, U32),
    TextureFormat::Rgb10a2Unorm => vector(Quad, F32),
    TextureFormat::Rg11b10Ufloat => vector(Quad, F32),
    TextureFormat::R64Uint => return None,
    TextureFormat::Rg32Uint => vector(Bi, U32),
    TextureFormat::Rg32Sint => vector(Bi, I32),
    TextureFormat::Rg32Float => vector(Quad, F32), // https://github.com/gfx-rs/wgpu/issues/7702
    TextureFormat::Rgba16Uint => vector(Quad, U32),
    TextureFormat::Rgba16Sint => vector(Quad, I32),
    ...
    TextureFormat::Depth24Plus => Scalar(F32),
    TextureFormat::Depth24PlusStencil8 => Scalar(F32),
    TextureFormat::Depth32Float => Scalar(F32),
    TextureFormat::Depth32FloatStencil8 => Scalar(F32),
    _ => return None,
  };
